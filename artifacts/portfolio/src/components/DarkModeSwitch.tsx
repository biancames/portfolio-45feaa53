  ...
  return (
    ...
    >
      <svg width="48" height="80" viewBox="0 0 48 80" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        />
        <line x1="24" y1="54" x2="24" y2="70" stroke="#3D4A1E" strokeWidth="2.5" strokeLinecap="round"/>
        <circle cx="24" cy="75" r="5" fill={dark ? "#3D4A1E" : "#A8CC2C"} stroke="#3D4A1E" strokeWidth="2"/>
        <text x="24" y="79.5" textAnchor="middle" fontFamily="Caveat, cursive" fontSize="7" fill={dark ? "#EDE8DC" : "#2C2A1E"} style={{userSelect:"none"}}>
          {dark ? "escuro" : "claro"}
        </text>
      </svg>
    </button>
